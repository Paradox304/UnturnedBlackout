...
namespace UnturnedBlackout.Database.Base
{
    public class Quest
    {
        ...
        public Quest(int questID, string questDesc, EQuestType questType, EQuestTier questTier, Dictionary<EQuestCondition, List<int>> questConditions, int targetAmount, int xP)
        {
            QuestID = questID;
            QuestDesc = questDesc;
            QuestType = questType;
