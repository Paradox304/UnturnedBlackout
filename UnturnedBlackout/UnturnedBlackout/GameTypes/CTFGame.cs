...
public class CTFGame : Game
{
    ...
    public IEnumerator EndGame()
    {
        ...
        var wonTeam = BlueTeam.Score > RedTeam.Score ? BlueTeam : RedTeam.Score > BlueTeam.Score ? RedTeam : new CTFTeam(-1, true, new TeamInfo(), 0, Vector3.zero);
    ...
    public override IEnumerator AddPlayerToGame(GamePlayer player)
    {
        ...
        switch (GamePhase)
        {
            ...
            case EGamePhase.Ending:
                CTFTeam wonTeam;
                wonTeam = BlueTeam.Score > RedTeam.Score ? BlueTeam : RedTeam.Score > BlueTeam.Score ? RedTeam : new CTFTeam(-1, true, new TeamInfo(), 0, Vector3.zero);
