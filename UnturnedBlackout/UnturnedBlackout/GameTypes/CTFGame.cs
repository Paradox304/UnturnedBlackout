    ...
    public class CTFGame : Game
    {
        ...
        public override void OnPlayerDead(Player player, CSteamID killer, ELimb limb, EDeathCause cause)
        {
            ...
            TaskDispatcher.QueueOnMainThread(() =>
            {
                ...
                if (isFirstKill)
                {
                    xpGained += Config.CTF.FirstKillXP;
                ...
                if ((cPlayer.GamePlayer.Player.Position - kPlayer.GamePlayer.Player.Position).sqrMagnitude > Config.LongshotRange)
                {
                ...
                Plugin.Instance.QuestManager.CheckQuest(cPlayer.GamePlayer.SteamID, EQuestType.Death, questConditions);
            ...
            if (cPlayer.Team.FlagID == itemData.item.id)
            {
                ...
                if (!cPlayer.Team.HasFlag)
                {
                    ...
                    ThreadPool.QueueUserWorkItem(async (o) =>
                    {
                        ...
                        await Plugin.Instance.DBManager.IncreasePlayerXPAsync(cPlayer.GamePlayer.SteamID, Config.CTF.XPPerFlagSaved);
                    });
                    return;
                }
                ...
                if (player.Player.Player.clothing.backpack == otherTeam.FlagID && !otherTeam.HasFlag)
                {
                    ...
                    ThreadPool.QueueUserWorkItem(async (o) =>
                    {
                        ...
                        await Plugin.Instance.DBManager.IncreasePlayerXPAsync(cPlayer.GamePlayer.SteamID, Config.CTF.XPPerFlagCaptured);
                    });
                }
                else
                {
