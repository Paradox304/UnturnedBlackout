...
namespace UnturnedBlackout.GameTypes
{
    public class TDMGame : Game
    {
        ...
        public IEnumerator GameEnd(TDMTeam wonTeam)
        {
            ...
            {
                Plugin.Instance.UI.SetupTDMLeaderboard(Players, Location, wonTeam, BlueTeam, RedTeam, false, IsHardcore, roundEndCases);
                WipeItems();
            });
        ...
        public override void OnPlayerDead(Player player, CSteamID killer, ELimb limb, EDeathCause cause)
        {
            ...
            ThreadPool.QueueUserWorkItem(async (o) => await Plugin.Instance.DB.IncreasePlayerDeathsAsync(tPlayer.GamePlayer.SteamID, 1));
