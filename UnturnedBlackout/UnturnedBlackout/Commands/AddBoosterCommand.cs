...
internal class AddBoosterCommand : IRocketCommand
{
    ...
    public void Execute(IRocketPlayer caller, string[] command)
    {
        ...
        Plugin.Instance.ActionDispatcher.QueueOnSecondThread(async () => await Plugin.Instance.DB.AddPlayerBoosterAsync(steamID, boosterType, boosterValue, expirationDays));
